    ...
    <footer className="mt-auto border-t-2 border-(--color-border) bg-(--color-surface) px-6 py-12">
      <div className="mx-auto max-w-6xl flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex flex-col items-center md:items-start gap-2">
          <img src={logo} alt="Kraftin'e logo" className="h-8 w-auto rounded-full" />
          <p className="text-[10px] uppercase font-bold tracking-widest text-(--color-muted)">
            Kraftin'e Floral Studio | Teresa, Rizal
          </p>
        ...
        <div className="flex gap-4">
          <a
            ...
            className="text-[12px] font-bold uppercase border-b-2 border-(--color-border) no-underline text-(--color-primary)"
          >
            Facebook
          </a>
          <a
        ...
        <p className="text-[11px] font-bold text-(--color-muted) uppercase tracking-[0.3em]">
          &copy; {currentYear}
        </p>
      </div>
    </footer>
